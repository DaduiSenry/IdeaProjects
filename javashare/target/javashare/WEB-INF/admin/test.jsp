      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="#"><i class="fa fa-circle-o"></i> 添加用户</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i> 删除用户</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i> 修改用户</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i> 查找用户</a></li>
          </ul>
        </li>
        <li class="active treeview">
          <a href="#">
            <i class="fa fa-dashboard"></i> <span>面试题管理</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu" >
            <li class="active"><a href="#"><i class="fa fa-circle-o"></i> 添加面试题</a></li>
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="#"><i class="fa fa-circle-o"></i> 添加书籍</a></li>
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="#"><i class="fa fa-circle-o"></i> 添加笔记</a></li>
         ...
         <li class="active treeview">
          <a href="#">
            <i class="fa fa-dashboard"></i> <span>视频管理</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li class="active"><a href="#"><i class="fa fa-circle-o"></i> 添加视频</a></li>
