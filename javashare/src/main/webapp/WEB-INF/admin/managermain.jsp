	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<section class="content">
				<div class="row">
					<div class="col-xs-12" id="table_user">
						<div class="box">
							<div class="box-body">
					...
					<div style="display:none" id="table_interview"><%@ include file="table_interview.jsp" %> </div>
					<div class="col-md-6">
  			<div style="display:none" id="show_insertuser" class="show_file"><%@ include file="insertuser.jsp" %> </div> 
            <div style="display:none" id="show_deleteuser" class="show_file"><%@ include file="deleteuser.jsp" %> </div> 
          <div style="display:none" id="show_updateuser" class="show_file"><%@ include file="updateuser.jsp" %> </div> 
          <div style="display:none" id="show_selectuser" class="show_file"><%@ include file="selectuser.jsp" %> </div> 
